...
export default function ModalAgregarServicios({
  ...
  // 🔹 Escuchar en tiempo real los servicios del negocio, ordenados por fecha
  useEffect(() => {
  ...
  // 📌 Cambiar horas o minutos (calcula duración total)
  ...
  // 📌 Añadir servicio vacío (se agrega en memoria arriba)
  const handleAgregar = () => {
        ...
        if (s.servicio.trim() !== "") {
          ...
          if (s.id) {
            ...
            await addDoc(preciosRef, {
              ...
              precio: precioFinal,
              duracion: s.duracion,
              createdAt: serverTimestamp(), // 👈 se guarda la fecha
            });
          }
        }
      }
